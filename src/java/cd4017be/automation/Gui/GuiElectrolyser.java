...
public class GuiElectrolyser extends GuiMachine {
	...
	private final Electrolyser tile;

	public GuiElectrolyser(Electrolyser tileEntity, EntityPlayer player) {
		super(new TileContainer(tileEntity, player));
		this.tile = tileEntity;
		this.MAIN_TEX = new ResourceLocation("automation", "textures/gui/electrolyser.png");
	}
	...
	public void initGui() {
		...
		guiComps.add(new ProgressBar(8, 63, 55, 32, 10, 184, 0, (byte)0));
		guiComps.add(new ProgressBar(9, 117, 55, 32, 10, 184, 10, (byte)0));
	}
