...
public class GuiGraviCond extends GuiMachine 
{
	...
	protected void drawGuiContainerForegroundLayer(int mx, int my) 
	{
		...
		this.drawFormatInfo(133, 37, 18, 10, "grav.need", Utils.formatNumber((double)tileEntity.netI1 * 1000D, 4, 0));
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int x, int y) 
	{
		...
		this.drawLocString(this.guiLeft + 26, this.guiTop + 52, 8, 0x404040, "grav.matter", Utils.formatNumber((double)tileEntity.netI0 * 1000D, 4, 0));
		this.drawStringCentered(String.format("%.0f %s", tileEntity.netF0 / 1000F, TooltipInfo.getEnergyUnit()), this.guiLeft + 61, this.guiTop + 18, 0x404040);
