...
public class GuiTextureMaker extends GuiMachine
{
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) 
	{
		...
		this.drawTexturedModalRect(this.guiLeft + oX + 4, this.guiTop + oY + 155, 115 + 18 * tileEntity.netI0, 106, 18, 18);
		...
		this.drawStringCentered("" + tileEntity.netI1, this.guiLeft + oX + 92, this.guiTop + oY + 156, 0x404040);
		this.drawStringCentered("" + tileEntity.netI2, this.guiLeft + oX + 92, this.guiTop + oY + 165, 0x404040);
	...
	protected void mouseClicked(int x, int y, int b) throws IOException 
	{
		if (this.isPointInRegion(264, 8, 16, 240, x, y)) {
			...
			tileEntity.netI1 -= b == 0 ? 1 : 10;
			this.sendValueChange(2, tileEntity.netI1);
		} else if (this.isPointInRegion(101 + oX, 155 + oY, 7, 9, x, y)) {
			tileEntity.netI1 += b == 0 ? 1 : 10;
			this.sendValueChange(2, tileEntity.netI1);
		} else if (this.isPointInRegion(76 + oX, 164 + oY, 7, 9, x, y)) {
			tileEntity.netI2 -= b == 0 ? 1 : 10;
			this.sendValueChange(3, tileEntity.netI2);
