...
public class GuiTeleporter extends GuiMachine {
	...
	public void initGui() {
		...
		guiComps.add(new Tooltip(11, 7, 33, 90, 18, "Estor2"));
		guiComps.add(new Text(12, 8, 38, 88, 8, "teleport.do#"));
		guiComps.add(new Text(13, 121, 4, 48, 8, "teleport.copy#"));
		guiComps.add(new Text(14, 0, ySize, xSize, 0, "teleport.warning#").center());
	...
	protected void setDisplVar(int id, Object obj, boolean send) {
		...
		case 9: 
			...
			else {dos.writeByte(AutomatedTile.CmdOffset).writeByte(0); break;}
