...
public class GuiTeslaTransmitter extends GuiMachine
{
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) 
	{
		...
		this.drawStringCentered("Energy = " + (int)(tileEntity.netF0 / 1000F) + TooltipInfo.getEnergyUnit(), this.guiLeft + 115, this.guiTop + 20, 0xffdf40);
	...
	protected void mouseClicked(int x, int y, int b) throws IOException 
	{
		...
		{
			try {
				tileEntity.netI0 = Short.parseShort(textField.getText());
